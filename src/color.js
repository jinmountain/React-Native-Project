export default {
	...
	grey3: '#626262', // light gray, information text
	grey4: '#EFEFEF', // touchable highlight underlay | theOtherUser message box background color 
	grey5: '#5A646A', // transparent gray background for buttons
	grey6: '#CCCCCC', // business bottom tap focused color
	grey7: '#606060', // light gray, information area icons 
